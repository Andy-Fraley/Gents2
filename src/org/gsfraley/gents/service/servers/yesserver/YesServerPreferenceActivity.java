...
public class YesServerPreferenceActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String serverPrefName = getIntent().getExtras().getString(SERVER_PREF_NAME, YesServer.NAME);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.yes_server_preference, menu);
		return true;
	}
	...
	public static class HelloServerPreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.servers_yesserver_preference);
		}
	}
}
