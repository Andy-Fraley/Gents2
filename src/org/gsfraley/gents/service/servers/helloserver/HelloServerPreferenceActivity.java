...
public class HelloServerPreferenceActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String serverPrefName = getIntent().getExtras().getString(SERVER_PREF_NAME, HelloServer.NAME);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.hello_server_preference, menu);
		return true;
	}
	...
	public static class HelloServerPreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.servers_helloserver_preference);
		}
	}
}
